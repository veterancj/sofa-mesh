...
${ISTIO_MOSN_RELEASE_DIR}/mosn: ${ISTIO_MOSN_RELEASE_PATH}
	mkdir -p $(DOCKER_BUILD_TOP)/proxyv2
	cp ${ISTIO_MOSN_RELEASE_PATH} ${ISTIO_MOSN_RELEASE_DIR}/mosn
...
docker.proxyv2: $(ISTIO_MOSN_RELEASE_DIR)/mosn
...
docker.proxytproxy: $(ISTIO_MOSN_RELEASE_DIR)/mosn
